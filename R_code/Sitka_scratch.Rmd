...
png(filename = './figs/SN05_heartrates_20200919-20200921.png',
		width = 5, height = 5, units = 'px',res=300)
mypch = '.'
mycex = 1.5
myspan = 0.1
...
loessFunc(t1$DateTimeAST, t1$forecastBPM, col = 5, lwd = 2, cex = mycex, span = myspan)
